...
class AttentionHead(nn.Module):
    ...
    def __init__(self, dim_embed, head_size, max_length):
        """
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, dim_embed, num_heads, head_size, max_length):
        """
...
class TranformerBlock(nn.Module):
    ...
    def __init__(self, dim_embed, num_heads, max_length):
        """
...
class TutorialLLM(nn.Module):
    ...
    def __init__(self, vocabulary_size, dim_embed, max_length, num_head, num_layer, device):
        """
