...
但为了照顾另一部分真正想要了解实现细节的人，本节还是对代码做个简要介绍。以下内容需要一定的编程知识，如有看不懂的地方，可以直接跳过，或在[GitHub仓库](https://github.com/jingedawang/TutorialLLM/discussions)中留言。
...
* `TutorialLLM.ipynb`是为读者提供的一个在线运行环境，参考README中的说明，在Google Colab中打开这个文件，即可在云上运行整个程序。
...
关于此项目的任何问题，读者都可以在代码库主页的[Issues](https://github.com/jingedawang/TutorialLLM/issues)或[Discussions](https://github.com/jingedawang/TutorialLLM/discussions)栏目发帖，看到后我会及时处理。一个开源项目的成功，少不了广大读者的帮助，在此提前向大家表示感谢。
